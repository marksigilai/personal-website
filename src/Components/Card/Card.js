						...
						return (
							<div className={styles.project} key={project.id}>
								...
								<div key={project.id} timeout={10000} classNames="slide">
									<p name="paragraph" className={styles.paragraph}>
										{" "}
										{project.description}{" "}
									</p>
									<div className={styles.btn}>
										<button type="button" onClick={() => this.setState({ key: project })}>
											More Info
										</button>
								...
								{this.state.key === project.id && (
									<div key={project.id} timeout={1000} classNames="slide">
										<div name="information" className={styles.info}>
											{project.information}
										</div>
										<div className={styles.btn}>
											<span class="material-icons">keyboard_arrow_left</span>
											<button type="button" onClick={() => this.setState({ key: null })}>
												Back
											</button>
										</div>
									</div>
