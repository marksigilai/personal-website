        ...
        <div className={styles.main}>
          ...
          <div className={styles.content} id='forms_container'>
            ...
            <p className={styles.call} >
              ...
              <CopyToClipboard text="236) 882 4370" onCopy={() => {this.setState({copied:'true', copy_status:'copied to clipboard'})}}>
                <button type='button' style={this.state.copied ? {color:'green'} : {color:'grey'}}><span class="material-icons">content_copy</span></button>
              </CopyToClipboard>
              <a href="tel:2368826885" className={styles.sp2} >(236) 882 4370</a>
            </p>
