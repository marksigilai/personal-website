...
class Landing extends Component {
	...
	async componentDidMount() {
		...
		tl.from(this.hello.current, 0.7, { y: 4, ease: Power1.easeInOut, delay: 2 })
			.from(this.title.current, 1, { y: -4, ease: Power3.easeInOut, delay: 0.8 })
			.from(this.subheading.current, 0.7, { y: -50, ease: Power3.easeInOut, delay: 0.7 })
			.from(this.btn.current, 1, { y: -10, ease: Power3.easeInOut, delay: 0.5 });
			...
			<div className={styles.landing}>
				<div className={styles.info_container}>
					...
					<div className={styles.titles_container}>
						...
						<h2 ref={this.subheading} className={styles.subtitle}>
				...
				<button id="btn" ref={this.btn} className={styles.btn} type="button">
					<span ref={this.arrow} class="material-icons">
						keyboard_arrow_down
					</span>
				</button>
			</div>
