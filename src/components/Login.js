        ...
        return(            
                <div id="login" ref={this.container} className={styles.login} >
                    ...
                    <form id='form' ref={this.login_form} className={styles.login_form} method='POST' onSubmit={this.handleSubmit}>
                        ...
                        <input id="signin_password" className={styles.login_password} type='password' value={this.state.password} onChange={this.myChangeHandler} name='password'/>
                        <br/>
                        <input className={styles.login_submit}type="submit" value="Login"/>    
                        <button className={styles.forgot_pass}>Forgot password?</button>        
                    </form>
                </div>              
        )
    }
